...
import com.silvana.homecare.service.MedicoService;
...
/**
 * REST controller for managing {@link com.silvana.homecare.domain.Medico}.
 */
@RestController
@RequestMapping("/api")
public class MedicoResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/medicos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Medico> partialUpdateMedico(
        ...
        Optional<Medico> result = medicoService.partialUpdate(medico);
